...
if (isset($_GET['hapus'])) {
    ...
    header("Location: dashboard_pengembalian.php");
    exit();
}
                                ...
                                <div class="page-header">
                                    ...
                                    <div class="page-header-breadcrumb">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Dashboard Pengembalian</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="project-table">
                                                    <table id="crm-contact" class="table table-striped table-responsive nowrap">
                                                        ...
                                                        <tbody>
															...
															echo "<td>
															<a href='edit-pengembalian.php?id=" . $row['id'] . "'><i class='icofont icofont-ui-edit' style='background-color: #cce5ff; color: #004080; border-radius: 30px; padding: 5px;'></i></a>
