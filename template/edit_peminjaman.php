...
<body>
    ...
    <form action="" method="post">
        ...
        Estimasi Peminjaman: <input type="date" name="estimasi_peminjaman" value="<?php echo $data_edit['estimasi_peminjaman']; ?>" required><br>
		...
		<a href="list_peminjaman.php">Kembali Ke List Peminjaman</a>	
    </form>
