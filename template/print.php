...
<header>
  <div class="headerSection">
    ...
    <div class="logoAndName">
	  ...
	  <img class="" src="assets/images/imlicon.png" alt="Theme-Logo" width="" height="50">
    
      <h1>Indo Motor Lestari</h1>
    </div>
    <!-- Details about the invoice are on the right top side of each page. -->
    <div class="invoiceDetails">
      <h2>Kartu Peminjaman</h2>
      <p>
        <?php $tanggal_pinjam = date("j M Y", strtotime($data['tanggal_pinjam']));
  ...
  <div class="headerSection">
    ...
    <div>
      <h3>Peminjaman Untuk</h3>
      <p>
        <b><?php echo $data['nama_peminjam']; ?></b>
      </p>
	  <br>
	   <br>	   
	  <h3>Barang Yang Dipinjam</h3>
	  <p>
        <b><?php echo $data['barang']; ?></b>
      </p>
    </div>
    <!-- Additional details can be placed below the invoice details. -->
    <div>
      <h3>Estimasi Peminjaman</h3>
      <p>
        <b><?php echo $data['estimasi_peminjaman']; ?></b>
      </p>
      <h3>Jumlah</h3>
      <p>
  ...
  <table>
    ...
    <tbody>
	 ...
	 <tr>
	  ...
	  <tr>
        <td>
          <b>Estimasi Peminjaman</b>
        </td>
        <td>
         <?php echo $data['estimasi_peminjaman']; ?>
        </td>
      </tr>
...
<aside>
  ...
  <div>
    <div>
      ...
      <p>
        Dimohon untuk melakukan pengembalian barang tepat waktu, apabila tidak maka akan dikenakan denda sesuai tanggal keterlambatan pengembalian.
      </p>
    </div>
  </div>
</aside>
