                                                        ...
                                                        <tbody>
															...
															while ($row = mysqli_fetch_assoc($result)) {
																...
																echo "<td><img src='" . $qrlink . "' alt='QR Code'></td>";
																	...
																	echo "<td>
																	 <a href='detail-barang.php?id_brg=" . $row['id_brg'] . "'><i class='icofont icofont-info-circle' style='background-color: #5bc0de; color: #fff; border-radius: 30px; padding: 5px;'></i></a>
