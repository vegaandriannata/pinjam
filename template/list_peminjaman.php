...
<head>
    ...
    if (result) {
        window.location.href = 'list_peminjaman.php?hapus=' + id;
    }
}
        ...
        <div class="container.search-bar">    
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form class="search-bar" action="list_peminjaman.php" method="GET">
...
<div>
        <button class="btn-input" onclick="location.href='input_peminjaman.html'">Input Data Peminjaman</button>
        <button class="btn-input custom-btn" onclick="location.href='list_pengembalian.php'">List Data Pengembalian</button>
        <button class="btn-input custom-btn-red" onclick="toggleFilterForm()">Filter Tanggal Pinjam</button>
</div>
		<form id="filterForm" class="date-filter" action="list_peminjaman.php" method="GET" style="display: none;">
        ...
        <table border="1">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td>
						<a href='edit_peminjaman.php?id=" . $row['id'] . "'><i class='fas fa-edit text-blue'></i></a>
						<a href='javascript:confirmDelete(" . $row['id'] . ")'><i class='fas fa-trash-alt text-red'></i></a>
						<a href='cetak.php?id=" . $row['id'] . "' target='_blank'><i class='fas fa-print'></i></a>
						</td>";
                echo "</tr>";
                $no++;
            }
