                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="j-wrapper j-wrapper-640">
                                                          <form action="proses_input.php" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" onsubmit="submitForm(event)" novalidate="">
                                                                ...
                                                                <div class="j-content">
                                                                    ...
                                                                    <div class="j-row">
                                                                        <div class="j-span6 j-unit">
                                                                            <div class="j-input">
                                                                                ...
                                                                                <input type="text" id="nama_peminjam" name="nama_peminjam" placeholder="Nama">
                                                                            </div>
                                                                        </div>
                                                                        <div class="j-span6 j-unit">
                                                                            <div class="j-input">
                                                                                ...
                                                                                <input type="text" id="barang" name="barang" placeholder="Barang">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- end name -->
                                                                    <!-- start email phone -->
                                                                        ...
                                                                        <div class=" j-unit">
                                                                            <div class="j-input">
                                                                                ...
                                                                                <input type="number" placeholder="Jumlah" id="jumlah" name="jumlah">
                                                                            </div>
                                                                        </div>
																	...
																	<div class="j-row">
                                                                        <div class="j-span6 j-unit">
                                                                           ...
                                                                           <span class="j-hint">Tanggal Pinjam</span>
                                                                                <input type="date" placeholder="Tanggal Pinjam" id="tanggal_pinjam" name="tanggal_pinjam">
                                                                            </div>
                                                                        </div>
                                                                        <div class="j-span6 j-unit">
                                                                            <div class="j-input">
                                                                           <span class="j-hint">Estimasi Pinjam</span>
                                                                                <input type="text" placeholder="Estimasi Pinjam" id="estimasi_peminjaman" name="estimasi_peminjaman">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="j-unit">
                                                                        <div class="j-input">
                                                                            ...
                                                                            <input type="text" id="kondisi_awal" placeholder="Kondisi awal" name="kondisi_awal">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="j-unit">
                                                                        <div class="j-input">
                                                                            <textarea placeholder="Keterangan" spellcheck="false" name="keterangan"></textarea>
...
<script>
    function submitForm(event) {
        ...
        window.location.href = 'dashboard-peminjaman.php';
    }
</script>
</body>
